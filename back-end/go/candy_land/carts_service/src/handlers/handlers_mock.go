...
func (m *MockHandlers) AddProductToCart(ctx context.Context, in *candyland_grpc.AddProductToCartRequest) (*candyland_grpc.AddProductToCartReply, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddProductToCart", ctx, in)
	ret0, _ := ret[0].(*candyland_grpc.AddProductToCartReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AddProductToCart indicates an expected call of AddProductToCart
func (mr *MockHandlersMockRecorder) AddProductToCart(ctx, in interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddProductToCart", reflect.TypeOf((*MockHandlers)(nil).AddProductToCart), ctx, in)
}
